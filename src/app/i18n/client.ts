...
import { type FallbackNs, useTranslation as useTranslationOrg } from "react-i18next";
...
i18next
  ...
  .use(resourcesToBackend((language: string, namespase: string) => import(`./locales/${language}/${namespase}.json`)))
  .init({
    ...getOptions(),
